...
def excel_both(dtinet_score_entries, neodti_score_entries):
    output = io.BytesIO()
    ...
    dtinet_sheet.set_column(4, 4, 500)
    ...
    for i, d in enumerate(neodti_score_entries):
        ...
        neodti_sheet.write(i+1, 4, d['smiles'])
